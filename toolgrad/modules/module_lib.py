...
def create_workflow_updater(kg_context: str = ""):
  ...
  Args:
    kg_context: Optional domain knowledge (e.g. entities/relations from a
      knowledge graph) grounding the synthesized query. Defaults to "",
      which renders an empty Domain Knowledge section and preserves the
      original prompt behavior.
  """
  predict_workflow_prompt = prompt_lib.PREDICT_WORKFLOW.partial(
