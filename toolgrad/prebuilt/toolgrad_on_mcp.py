...
def create_graph_on_mcp(
  ...
  """Build the ToolGrad graph on MCP tools.

  Args:
    api_sampler: Optional callable ``(tools, num_apis) -> tools`` replacing
      uniform random API sampling (e.g. knowledge-graph-guided sampling).
  """
